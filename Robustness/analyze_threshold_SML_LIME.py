...
df = pd.read_csv('data/threshold_results_SML_lime.csv', index_col=0)
...
plt.savefig("0A_SML_ROBUSTNESS_LIME_f1_first.png")
...
# Save the plot
plt.savefig("0A_SML_LIME_ROBUSTNESS_f1_first_with_binned_trend.png")