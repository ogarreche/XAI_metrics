...
df = pd.read_csv('data/threshold_results_SML_shap.csv', index_col=0)
...
plt.ylabel("Percentage of biased feature as 1st", fontsize=18)

sns.scatterplot(f1s, fsts, ax=ax)
plt.savefig("0A_SML_ROBUSTNESS_shap_f1_first.png")
...
# Save the plot
plt.savefig("0A_SML_ROBUSTNESS_SHAP_f1_first_with_binned_trend.png")